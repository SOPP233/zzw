...
public class ProductionPlanController {
    ...
    @PostMapping
    public Map<String, Object> create(@RequestBody ProductionPlan data) {
        mapper.insert(data);
        return successWithData(data);
    }

    @PutMapping("/{id}")
    public Map<String, Object> update(@PathVariable String id, @RequestBody ProductionPlan data) {
        data.setBatchId(id);
    ...
    public Map<String, Object> page(@RequestParam(defaultValue = "1") long pageNo,
        ...
        IPage<ProductionPlan> result = mapper.selectPage(new Page<>(pageNo, pageSize), new QueryWrapper<ProductionPlan>().orderByDesc("created_at"));
