...
public class SysRoleController {
    ...
    @PostMapping
    public Map<String, Object> create(@RequestBody SysRole data) {
        mapper.insert(data);
        return successWithData(data);
    }

    @PutMapping("/{id}")
    public Map<String, Object> update(@PathVariable String id, @RequestBody SysRole data) {
        data.setRoleCode(id);
    ...
    public Map<String, Object> page(@RequestParam(defaultValue = "1") long pageNo,
        ...
        IPage<SysRole> result = mapper.selectPage(new Page<>(pageNo, pageSize), new QueryWrapper<SysRole>().orderByDesc("created_at"));
