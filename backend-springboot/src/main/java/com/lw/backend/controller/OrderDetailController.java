...
public class OrderDetailController {
    ...
    @PostMapping
    public Map<String, Object> create(@RequestBody OrderDetail data) {
        mapper.insert(data);
        return successWithData(data);
    }

    @PutMapping("/{id}")
    public Map<String, Object> update(@PathVariable String id, @RequestBody OrderDetail data) {
        data.setDetailId(id);
    ...
    public Map<String, Object> page(@RequestParam(defaultValue = "1") long pageNo,
        ...
        IPage<OrderDetail> result = mapper.selectPage(new Page<>(pageNo, pageSize), new QueryWrapper<OrderDetail>().orderByDesc("created_at"));
