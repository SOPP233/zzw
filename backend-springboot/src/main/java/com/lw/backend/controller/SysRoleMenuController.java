...
import com.lw.backend.modules.mes.entity.SysRoleMenu;
import com.lw.backend.modules.mes.mapper.SysRoleMenuMapper;
...
public class SysRoleMenuController {
    ...
    @PostMapping
    public Map<String, Object> create(@RequestBody SysRoleMenu data) {
        mapper.insert(data);
        return successWithData(data);
    }

    @PutMapping("/{id}")
    public Map<String, Object> update(@PathVariable Long id, @RequestBody SysRoleMenu data) {
        data.setId(id);
    ...
    public Map<String, Object> page(@RequestParam(defaultValue = "1") long pageNo,
        ...
        IPage<SysRoleMenu> result = mapper.selectPage(new Page<>(pageNo, pageSize), new QueryWrapper<SysRoleMenu>().orderByDesc("created_at"));
